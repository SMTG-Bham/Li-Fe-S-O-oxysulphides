...
class TheoreticalCathode:
    ...
    def __init__(self, comp=None, structure=None, nli=None, avg_voltage=None, cycle_factor=1.0, label=None, plot_args=None,
                ):
        """
    ...
    def __repr__(self):
        string = "Cathode:{}, with maximum {} Li extaction ({} possible in practice)".format(self.comp.reduced_formula, self.nli, self.cycle_factor)
        return string
